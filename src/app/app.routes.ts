...
export const routes: Routes = [
    
    {
        ...
        children: [
            { path: '', loadChildren: () => import('./@theme/components/dashboard/dashboard.module').then(m => m.DashboardModule) },
            { path: 'uikit', loadChildren: () => import('./@theme/components/uikit/uikit.module').then(m => m.UIkitModule) },
